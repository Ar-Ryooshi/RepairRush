...
class TechnicienApp:
    def __init__(self, root):
        ...
        self.images = {
            "Mécanicien": [ImageTk.PhotoImage(Image.open(f"images\Tech1.png").resize((100, 100), Image.LANCZOS)) for i in range(1, 4)],
            "Informaticien": [ImageTk.PhotoImage(Image.open(f"images\Tech2.png").resize((100, 100), Image.LANCZOS)) for i in range(1, 4)],
            "Électricien": [ImageTk.PhotoImage(Image.open(f"images\Tech4.png").resize((100, 100), Image.LANCZOS)) for i in range(1, 4)]
        }
